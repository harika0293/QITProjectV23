  ...
  return (
    <Layout style={styles.Container}>
      <Layout style={styles.Head}>
        ...
        />
        <Icon style={styles.icon} fill="#7810E0" name="file-add-outline" />
        <Text
          style={{fontSize: 25, fontFamily: 'Recoleta-Bold', marginLeft: 60}}>
          Add Notes
        </Text>
        <Icon style={styles.icon1} fill="#8F9BB3" name="close-outline" />
      </Layout>
